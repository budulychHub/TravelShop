...
<div class="container">
	<h2>
		Add tent<small>(enter data)</small>
		${exception}
	</h2>

	<form:form modelAttribute="tent" action="addTent" method="post">
		<div class="group">
		...
		<div class="group">
			<form:input path="copacity" />
			<span class="highlight"></span> <span class="bar"></span> <label>Copacity</label>
		</div>
